        ...
        {loading ? (
          ...
          <div className="bg-white rounded-3xl border border-slate-100 p-12 text-center shadow-sm max-w-xl mx-auto my-8">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 bg-orange-500 hover:bg-orange-600 text-white font-bold text-xs px-5 py-2.5 rounded-xl transition shadow-sm cursor-pointer"
            >
              <MdWork size={16} /> Go to Placement Drives
            </button>
          </div>
        ) : (
          <>
                          ...
                          <tr key={candidate._id} className={isChecked ? "bg-orange-50/40" : "hover:bg-slate-50"}>
                            ...
                            <td className="p-4">
                              {resumeURL ? (
                                <a
                                  ...
                                  className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-[11px] font-bold bg-orange-50 text-orange-600 hover:bg-orange-100 hover:text-orange-700 transition"
                            ...
                            <td className="p-4">
                              <select
                                ...
                                className={`px-3 py-1 rounded-full text-[11px] font-extrabold border outline-none cursor-pointer ${status === "Shortlisted for Interview" ? "bg-purple-50 text-purple-700 border-purple-200" :
